                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:bg-gray-800">
                            @foreach ($schedules as $schedule)
                                <tr>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $schedule->staff->name }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $schedule->date }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $schedule->start_time }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $schedule->end_time }}</td>
                                    <td class="whitespace-nowrap px-6 py-4">{{ $schedule->description }}</td>
